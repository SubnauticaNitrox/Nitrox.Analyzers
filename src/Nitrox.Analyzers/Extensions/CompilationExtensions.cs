...
internal static class CompilationExtensions
{
    ...
    /// <returns></returns>
    public static INamedTypeSymbol? GetType(this Compilation compilation, string assemblyNameWithoutDll, string fullTypeName) => compilation.GetTypesByMetadataName(fullTypeName).FirstOrDefault(a => a.ContainingAssembly.Name.Equals(assemblyNameWithoutDll, StringComparison.Ordinal));
}
